@testset "SciML Style" begin
    ...
    @testset "function argument indent" begin
        str = raw"""
    ...
    @testset "indent on rhs of assignment" begin
        # https://github.com/JuliaEditorSupport/JuliaFormatter.jl/issues/935
        str = "xyz = T[a => 1,\n      b => 2]"
        yas_result = "xyz = T[a => 1,\n        b => 2]"
        sciml_result = "xyz = T[a => 1,\n    b => 2]"
        @test format_text(str, SciMLStyle(); yas_style_nesting = true) == yas_result
